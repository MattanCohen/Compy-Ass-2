...
OCAML_SRC_FOLDER = 'src/scheme_files/src'
OCAML_BUILD_FOLDER = 'src/scheme_files/build'
...
def main():
    ...
    output_asm_file = Path(OCAML_BUILD_FOLDER, f"{OUTPUT_FILE}.asm").absolute().as_posix()
    print("Path:", output_asm_file)
    print("Compiling scheme...")
    print(input_content)
    Path(output_asm_file).write_text("")
